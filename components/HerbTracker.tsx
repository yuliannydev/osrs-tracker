...
function CropNav({
  ...
  const activeStyle: React.CSSProperties = {
    ...base,
    background: "linear-gradient(180deg, var(--bg-panel-light) 0%, var(--bg-panel-mid) 100%)",
...
function SelectionSummary({ herb, flower }: { herb: string; flower: string }) {
  ...
  return (
    ...
    >
      <span style={{ fontSize: "0.7rem", color: "var(--text-dim)", textTransform: "uppercase", letterSpacing: "0.05em", marginRight: 4 }}>
        This run:
      </span>
      {herb && (
        <span
        ...
        <div style={{ padding: 24 }}>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
            ...
            <div>
              ...
              <CropNav active={cropTab} onChange={setCropTab} />
              ...
              <div>
                ...
                <div
                  style={{
                    ...
                    fontSize: "0.9rem",
                    fontWeight: "bold",
                    color: yieldHerbs + yieldFlowers > 0 ? "var(--gold)" : "var(--text-dim)",
                    height: 34,
                    display: "flex",
                    alignItems: "center",
                  }}
            ...
            <SelectionSummary herb={herb} flower={flower} />
  ...
  return (
    <div>
      ...
      >
        ...
        <div className="stat-card">
          <span className="value" style={{ color: "#90e090" }}>
            {totalHerbs}
          </span>
          <span className="label">Herbs</span>
        </div>
        <div className="stat-card">
          <span className="value" style={{ color: "#e090d0" }}>
            {totalFlowers}
          </span>
      ...
      {/* Modal */}
      {showModal && (
        <AddModal onClose={() => setShowModal(false)} onSave={addEntry} />
      )}
    </div>
  );
}
